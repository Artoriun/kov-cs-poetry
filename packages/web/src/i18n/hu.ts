...
export const hu: Dict = {
  ...
  admin: {
    ...
    hidePoem: 'Vers elrejtése',
    hidePoemBody: 'A vers eltűnik a webhelyről. Bármikor visszaállíthatja innen.',
    hidden: 'Rejtett',
    restorePoem: 'Vers visszaállítása',
    discardDraft: 'Vers elvetése',
    discardDraftBody: 'Ez a vers még nem lett mentve, így nincs honnan visszaállítani.',
