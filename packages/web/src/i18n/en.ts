...
export const en = {
  ...
  admin: {
    ...
    hidePoem: 'Hide poem',
    hidePoemBody:
      'The poem disappears from the site. You can bring it back from here whenever you like.',
    hidden: 'Hidden',
    restorePoem: 'Restore poem',
    discardDraft: 'Discard poem',
    discardDraftBody: 'This poem has never been saved, so there is nothing to bring it back from.',
